                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input type="text" name="allowance_code" id="allowance_code" class="form-input mt-1 block w-full" required>
                                </div>
                                <div class="col-span-6 sm:col-span-2">
                                    <label for="allowance_name" class="block font-medium text-gray-700">Name</label>
                                    <input type="text" name="allowance_name" id="allowance_name" class="form-input mt-1 block w-full" required>
                                </div>
                                <div class="col-span-6 sm:col-span-2">
                                    <label for="allowance_amount" class="block font-medium text-gray-700">Amount</label>
                                    <input type="text" name="allowance_amount" id="allowance_amount" class="form-input mt-1 block w-full" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <tr>
                            ...
                            <td class="border-b px-4 py-2">
                                <a href="{{ route('allowances.edit', $allowance) }}"
                                    ...
                                    <form class="inline-block" action="{{ route('allowances.destroy', $allowance) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
