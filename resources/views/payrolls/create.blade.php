                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <input type="text" name="ref_number" id="ref_number" class="block w-full mt-1 rounded" required>
                                </div>

                                <div class="col-span-6 sm:col-span-2">
                                    <label for="date_from" class="block font-medium text-gray-700">Date From</label>
                                    <input type="date" name="date_from" id="date_from" class="block w-full mt-1 rounded" required>
                                </div>

                                <div class="col-span-6 sm:col-span-2">
                                    <label for="date_to" class="block font-medium text-gray-700">Date To</label>
                                    <input type="date" name="date_to" id="date_to" class="block w-full mt-1 rounded" required>
                                </div>

                                <div class="col-span-6 sm:col-span-2">
                                    <label for="status" class="block font-medium text-gray-700">Status</label>
                                    <input type="text" name="status" id="status" class="block w-full mt-1 rounded" required>
                                </div>
                            </div>
                        </div>
