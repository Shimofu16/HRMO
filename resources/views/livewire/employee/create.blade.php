<div class="overflow-hidden sm:rounded-md">
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        ...
        @csrf
        @if ($errors->any())
            <div class="px-3 py-5 mb-3 text-white bg-red-500 rounded">
                <ul>
        ...
        <div class="px-4 py-5 bg-white shadow sm:p-6">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                @if (!$isJOSelected && !$isCOSSelected && !$isElectSelected)
                    <div class="col-span-6 sm:col-span-2">
                                ...
                                @forelse ($allowances as $allowance)
                                    <div class="flex items-center mt-1" wire:key="{{ $allowance->id }}">
                                        <input type="checkbox" name="allowance_{{ $allowance->id }}"
                                            id="allowance_{{ $allowance->id }}" class="mr-2 form-checkbox" checked
                                            disabled>
