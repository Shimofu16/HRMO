...
<head>
    ...
    <style>
        ...
        *,
        ...
        .bg-purple-600 {
            background-color: #e5d1fe
        }

        .bg-purple-600:hover {
            background-color: #561972
        }

        .bg-purple-600:hover,
        .bg-purple-600:hover .btn-txt {
            color: white
        }
...
<body class="wallpaper-welcome">
    <div class="items-center justify-center dark:bg-gray-100 mt-50">
        <div class="flex mx-7">
            @if (Route::has('login'))
                @auth
