...
<aside id="default-sidebar" class="fixed  left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0  border-r-gray-200" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
       ...
       <ul class="space-y-2 font-medium pt-4 border-t border-gray-200">
          ...
          <li>
            <a href="{{ route('sgrades.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg   group {{ request()->routeIs('sgrades.index') ? 'text-white bg-purple-700 ' : ' hover:bg-gray-100' }}">
